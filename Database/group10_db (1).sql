...
--
-- Host: localhost
-- Generation Time: Apr 21, 2023 at 03:46 PM
...
(8, 'Vimal', 2, 'Describe the Topic', '#vimal', '2023-04-21 15:45:01', '2023-04-21 15:45:01');
...
(3, 2, 'drybhaijamal', 'Testing', '2023-04-21 15:45:17', NULL, NULL, NULL, NULL);
...
--
-- Table structure for table `thread_8`
--

CREATE TABLE `thread_8` (
  `comment_id` int NOT NULL,
  `commenter_id` int NOT NULL,
  `commenter_username` varchar(50) NOT NULL,
  `comment` varchar(4000) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
--
-- Indexes for table `thread_8`
--
ALTER TABLE `thread_8`
  ADD PRIMARY KEY (`comment_id`),
  ADD KEY `commenter_user_id_t8_idx` (`commenter_id`),
  ADD KEY `commenter_username_t8_idx` (`commenter_username`),
  ADD KEY `comment_reply_id_t8_idx` (`replying_to`);
...
--
ALTER TABLE `threads`
  MODIFY `threadid` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `thread_8`
--
ALTER TABLE `thread_8`
  MODIFY `comment_id` int NOT NULL AUTO_INCREMENT;
...
--
-- Constraints for table `thread_8`
--
ALTER TABLE `thread_8`
  ADD CONSTRAINT `comment_reply_id_t8` FOREIGN KEY (`replying_to`) REFERENCES `thread_8` (`comment_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `commenter_user_id_t8` FOREIGN KEY (`commenter_id`) REFERENCES `users` (`userid`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `commenter_username_t8` FOREIGN KEY (`commenter_username`) REFERENCES `users` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;
